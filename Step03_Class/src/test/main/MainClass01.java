...
public class MainClass01 {
	public static void main(String[] args) throws IOException {
		...
		//랜덤한 숫자를 얻어내고 싶다면? 랜덤한 숫자를 생성해주는 기능을
		//가지고 있는 객체가 필요하다
		Random ran = null;
		...
		// 콘솔창에 문자열을 출력하고 싶다면? 콘솔창에 문자열을 출력해주는
		//기능을 가지고 있는 객체가 필요하다
		
		
		//파일 시스템에 memo.txt파일을 만들고 싶다면?
		//파일을 만들 수 있는 기능을 가지고 있는 객체가 필요하다
		File f = new File("C://playground/memo.txt");
		f.createNewFile();
		
		//콘솔창에 입력한 숫자나 문자열을 읽어들이고 싶다면?
		//콘솔창에 입력한 내용을 이용해서 int나 String을 만들어내는
		//기능을 가지고 있는 객체가 필요하다
