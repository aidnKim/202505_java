...
public class MyFrame extends JFrame implements ActionListener{
	...
	public MyFrame() {
		...
		//종료(x) 버튼을 눌렀을 대 프로세스(app) 전체가 종료되도록 한다
		...
		//프레임의 add() 메소드를 호출하면서 JButton 객체의 참조값을 전달하면
		//프레임에 버튼이 배치된다
		add(btn1);
		add(btn2);
		add(btn3);
		...
		//UI에 어떤 동작이 일어났을 때 호출될 예정인 메소드를 가지고 있는 
		//ActionListener 객체
		...
		//메소드가 1개니까 함수모양으로 ActionListener 객체를 만들 수 있다
	...
	// ActionListener 인터페이스를 구현했기 때문에 강제로 Override된 메소드
	@Override
	public void actionPerformed(ActionEvent e) {
