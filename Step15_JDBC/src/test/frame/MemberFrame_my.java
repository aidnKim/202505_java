...
public class MemberFrame_my extends JFrame{
	//필요한 필드 정의하기
	...
	public void printMember() {
		//기존에 출력된 내용을 모두 삭제하고
		model.setRowCount(0);
		//MemberDao 객체를 이용해서 회원목록을 얻어온 다음 실제 회원목록을 table 에
		//반복문 돌면서 출력해보세요
	...
	public static void main(String[] args) {
		MemberFrame_my f=new MemberFrame_my();
		f.setTitle("회원 정보");
